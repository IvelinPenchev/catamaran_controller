...
{
  return (linear_pos_[iteration-1] + linear_vel_[iteration-1]*(TIME_INTERVAL) + linear_acc_[iteration-1]*(TIME_INTERVAL^2));
}
...
{
 return (angular_pos_[iteration-1] + angular_vel_[iteration-1]TIME_INTERVAL + angular_acc_[iteration-1]*(TIME_INTERVAL^2);
}
